...
var auth_local_strategy_1 = require("./config/auth.local.strategy");
var auth_jwt_strategy_1 = require("./config/auth.jwt.strategy");
...
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [auth_service_1.AuthService, auth_local_strategy_1.LocalStrategy, auth_jwt_strategy_1.JwtStrategy],
