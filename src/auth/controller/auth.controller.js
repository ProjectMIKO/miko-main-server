...
var auth_local_config_1 = require("../config/auth.local.config");
var AuthController = function () {
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.UseGuards)(auth_local_config_1.AuthLocalConfig), (0, common_1.Post)('login')];
