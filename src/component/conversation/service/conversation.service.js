...
var ConversationService = function () {
    ...
    var ConversationService = _classThis = /** @class */ (function () {
        function ConversationService_1(conversationModel) {
            this.conversationModel = conversationModel;
        }
        ConversationService_1.prototype.createNewConversation = function (conversationCreateDto) {
            return __awaiter(this, void 0, void 0, function () {
                var conversationModel;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            conversationModel = new this.conversationModel(conversationCreateDto);
                            return [4 /*yield*/, conversationModel.save()];
                        case 1:
                            _a.sent();
                            console.log('CreateNewConversation ID: ' + conversationModel._id.toString());
                            return [2 /*return*/, conversationModel._id.toString()];
                    }
                });
            });
        };
