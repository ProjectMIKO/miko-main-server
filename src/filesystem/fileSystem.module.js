...
var fileSystem_service_1 = require("./service/fileSystem.service");
var fileSystem_controller_1 = require("./controller/fileSystem.controller");
...
var FileSystemModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            exports: [fileSystem_service_1.FileSystemService],
        })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var FileSystemModule = _classThis = /** @class */ (function () {
        function FileSystemModule_1() {
        }
        return FileSystemModule_1;
    }());
