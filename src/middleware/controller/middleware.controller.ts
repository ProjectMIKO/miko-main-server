...
export class MiddlewareController {
  ...
  async summarizeText(@Body() summarizeRequestDto: SummarizeRequestDto): Promise<SummarizeResponseDto> {
    return this.middlewareService.summarizeText(summarizeRequestDto);
  }
}
